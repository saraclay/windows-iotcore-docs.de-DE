...
---
# <a name="cortana-on-iot-core"></a>Cortana unter IoT Core

Cortana ist ein persönlicher digitaler Assistent funktioniert auf allen Geräten können Sie Ihnen tagtäglich. Er erfährt Sie; können Sie das erledigen von Aufgaben; Interaktion mit natürlicher Sprache konsistente, kontextbezogene so verwenden Sie; und immer sieht sich für Sie. Cortana hat eine bleibendem Persönlichkeit und Stimme.

Um intelligent physisch Unterstützung für Ihr Gerät mit dem Cortana-SDK zu aktivieren, besuchen Sie [der Cortana-Entwicklungscenter](http://www.aka.ms/cortanadevices).

Cortana unter IoT Core konzentriert kommerziellen Szenarien in der Zukunft sich auf. Updates werden bald erhältlich sein. 
