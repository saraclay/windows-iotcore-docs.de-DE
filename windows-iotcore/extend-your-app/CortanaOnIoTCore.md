---
title: Cortana unter IoT Core
author: saraclay
ms.author: saclayt
ms.date: 08/28/2017
ms.topic: article
description: Erfahren Sie, wie Sie beginnen, und installieren Updates für Cortana unter Windows IoT Core.
keywords: Windows Iot, Cortana, Voicemail, KI, digitalen Assistentin, Sprache
ms.openlocfilehash: c18534a532b0588b54f377acf1092d6916e8a673
ms.sourcegitcommit: ef85ccba54b1118d49554e88768240020ff514b0
ms.translationtype: MT
ms.contentlocale: de-DE
ms.lasthandoff: 04/11/2019
ms.locfileid: "59512369"
---
# <a name="cortana-on-iot-core"></a><span data-ttu-id="8c21d-104">Cortana unter IoT Core</span><span class="sxs-lookup"><span data-stu-id="8c21d-104">Cortana on IoT Core</span></span>

<span data-ttu-id="8c21d-105">Cortana ist ein persönlicher digitaler Assistent funktioniert auf allen Geräten können Sie Ihnen tagtäglich.</span><span class="sxs-lookup"><span data-stu-id="8c21d-105">Cortana is a personal digital assistant working across all your devices to help you in your daily life.</span></span> <span data-ttu-id="8c21d-106">Er erfährt Sie; können Sie das erledigen von Aufgaben; Interaktion mit natürlicher Sprache konsistente, kontextbezogene so verwenden Sie; und immer sieht sich für Sie.</span><span class="sxs-lookup"><span data-stu-id="8c21d-106">She learns about you; helps you get things done by completing tasks; interacts with you using natural language in a consistent, contextual way; and always looks out for you.</span></span> <span data-ttu-id="8c21d-107">Cortana hat eine bleibendem Persönlichkeit und Stimme.</span><span class="sxs-lookup"><span data-stu-id="8c21d-107">Cortana has a consistent visual identity, personality, and voice.</span></span>

<span data-ttu-id="8c21d-108">Um intelligent physisch Unterstützung für Ihr Gerät mit dem Cortana-SDK zu aktivieren, besuchen Sie [der Cortana-Entwicklungscenter](http://www.aka.ms/cortanadevices).</span><span class="sxs-lookup"><span data-stu-id="8c21d-108">To enable hands-free intelligent assistance in your device with the Cortana Device SDK, please visit [The Cortana Dev Center](http://www.aka.ms/cortanadevices).</span></span>

<span data-ttu-id="8c21d-109">Cortana unter IoT Core konzentriert kommerziellen Szenarien in der Zukunft sich auf.</span><span class="sxs-lookup"><span data-stu-id="8c21d-109">Cortana on IoT Core will focus on commercial scenarios in the future.</span></span> <span data-ttu-id="8c21d-110">Updates werden bald erhältlich sein.</span><span class="sxs-lookup"><span data-stu-id="8c21d-110">Updates will come soon.</span></span> 
