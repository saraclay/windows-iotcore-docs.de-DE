...
---
# <a name="release-notes-for-build-17763253"></a>Anmerkungen zu dieser Version erstellen 17763.253
_Buildnummer 17763.253. Februar 2019._
...
* Die für das Abbild Dragon Board verwendete BSP-Version ist 2120.0.0.0. 
...
* Helligkeit-verwaltungseinstellungen beibehalten nicht auf IoT beim Überschreiben.
...
#### <a name="accessing-public-documents"></a>Zugreifen auf Öffentliche Dokumente
Auf die zugrunde liegenden APIs für den Dateizugriff wurde eine Änderung vorgenommen, müssen Sie eine Anwendung BroadFileSystem Zugriff angeben, um das Verzeichnis für die Öffentliche Dokumente zugreifen.

das. XML-dateicodeausschnitt sollte folgendermaßen aussehen:
```
<Package
...
Einige USB-Tastaturen und Mäusen funktioniert möglicherweise nicht unter IoT Core. Verwenden einer anderen Tastatur oder Maus. Eine Liste der überprüften Peripheriegeräte befinden sich die [Dokumentation](https://docs.microsoft.com/en-us/windows/iot-core/learn-about-hardware/hardwarecompatlist).
...
* [Hinzufügen einer Datei und die Einstellung in der Registrierung zu einem Bild](https://msdn.microsoft.com/en-us/library/windows/hardware/mt670641(v=vs.85).aspx)
