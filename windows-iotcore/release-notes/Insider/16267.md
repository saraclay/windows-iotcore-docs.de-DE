...
---
# <a name="release-notes-for-build-16267"></a>Anmerkungen zu dieser Version erstellen 16267

_Buildnummer 16267. August 2017_
...
* Aufgrund der Intel-EOL (End-of-Life) für Joule werden FFUs für Joule bald eingestellt werden. Keine Joule FFU wird für RS3 RTM veröffentlicht. Kunden sollten eine Alternative zu identifizieren, mit einer anderen Plattform unterstützt SOCs - [Weitere Informationen](../../learn-about-hardware/SoCsAndCustomBoards.md)
* IOT_WEBB_EXTN-Funktion wurde umgestaltet, um die Onboarding-Funktion zu entfernen. Die Onboarding-Funktion ist jetzt als IOT_ONBOARDING_APP verfügbar.
Mit diesem Update die Onboarding-Funktion entfernt werden, und Benutzer, die mit dem Onboarding-Feature sollte ihr Gerät aus, um dieses Feature erneut neu blinken.
...
* Eine EXE-Datei über Windows.System.ProcessLauncher aufrufen, es sei denn, sie von Microsoft signiert ist, sind Store veröffentlichten apps nicht.
* Visual Studio-debugging für JavaScript-apps funktioniert nicht. Apps bereitgestellt, und ohne den Debugger von Visual Studio gestartet werden können.
Apps können auch aus Visual Studio bereitgestellt und aus dem Device Portal oder die iotstartup.exe gestartet werden.
...
* Erstellung von Abbildern möglicherweise aufgrund von Fehlern der InstallOemCerts.cmd-Befehl.
* Hintergrundaufgaben werden in der Ansicht Apps Manager in Windows Device Portal (WDP) nicht angezeigt.
...
http://go.microsoft.com/fwlink/?LinkId=708613. installiert haben.
