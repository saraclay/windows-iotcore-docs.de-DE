...
---
# <a name="release-notes-for-build-17692"></a>Anmerkungen zu dieser Version erstellen 17692
_Buildnummer 17692. Juni 2018._
...
* Node.js und Python kann nicht in UWP-apps verwendet werden. Ältere Beispiele in den folgenden Sprachen möglicherweise nicht mehr ordnungsgemäß. Microsoft erwägt Alternativen für eine spätere Version. 
* Cortana SDK reagiert nicht auf "Hey Cortana" auf QDB MBM-64. 
* CortanaSDK gibt die Ergebnisse von Websuchen nicht zurück. 
* Fehler beim Installieren von Smart Display-app. 
* MiraCast kann keine Verbindung hergestellt, um Dongle (QDB-Dongle >).
* DMDashboard löst eine Ausnahme, die versuchen, die Geräteinformationen nach Azure-Registrierung zu lesen.
* OpenSSH funktioniert nicht ordnungsgemäß mit IoTCore.
* OnBoarding Hummingboard schlägt fehl.
* Up2 kann nicht gestartet werden.
